...
public class MarketingModuleBAK extends JFrame implements ActionListener, MouseListener, KeyListener{
...
//        mostSoldProd();
	...
	private void objComponent() {
		...
		lblLogo_1.setIcon(new ImageIcon(MarketingModuleBAK.class.getResource("/KBN/resources/kbnlogo.png")));
		...
		btnDashboard.setIcon(new ImageIcon(MarketingModuleBAK.class.getResource("/KBN/resources/Marketing/marketingButton.png")));
...
//		orderPanel.btnDelivery.addActionListener(this);
	...
	public void mousePressed(MouseEvent e) {
		...
		if(e.getComponent() instanceof JButton) {
			...
			if(btnChecker == c)
				((JButton)c).setIcon(new ImageIcon(MarketingModuleBAK.class.getResource("/KBN/resources/Marketing/marketingButton.png")));
