...
public class ArchivePanelMain extends JPanel implements MouseListener {
	
	public JTextField txtSearchBar;
	public JButton btnSearch;
	public JScrollPane container;

	public ArchivePanelMain() {
		...
		btnSearch.setIcon(new ImageIcon(ArchivePanelMain.class.getResource("/KBN/resources/SearchBarUniversal.png")));
