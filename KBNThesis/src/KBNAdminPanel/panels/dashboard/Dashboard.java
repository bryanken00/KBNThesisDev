package KBNAdminPanel.panels.dashboard;
...
public class Dashboard extends JPanel {
	...
	public Dashboard() {
		...
		lblDailyPercent.setIcon(new ImageIcon(Dashboard.class.getResource("/KBN/resources/Marketing/dashboard/PercentagePNG/82.png")));
		...
		lblWeeklyPercent.setIcon(new ImageIcon(Dashboard.class.getResource("/KBN/resources/Marketing/dashboard/PercentagePNG/100.png")));
		...
		lblMonthlyPercent.setIcon(new ImageIcon(Dashboard.class.getResource("/KBN/resources/Marketing/dashboard/PercentagePNG/13.png")));
		...
		lblYearlyPercent.setIcon(new ImageIcon(Dashboard.class.getResource("/KBN/resources/Marketing/dashboard/PercentagePNG/13.png")));
